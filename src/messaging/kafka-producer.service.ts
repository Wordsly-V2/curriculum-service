...
export class KafkaProducerService implements OnModuleInit, OnModuleDestroy {
    ...
    async onModuleInit(): Promise<void> {
        ...
        this.kafka = new Kafka({
            clientId: 'curriculum-service-producer',
            brokers: brokerList,
            ssl:
                ca && cert && key
                    ? {
        ...
        try {
            ...
            // learners reading the path do not need Kafka. Sends no-op until a
            // restart reconnects, exactly as they do when KAFKA_BROKERS is unset.
            this.producer = null;
            this.kafka = null;
            this.logger.error(
